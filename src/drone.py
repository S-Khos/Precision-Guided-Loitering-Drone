...
class Tello:
    ...
    def __init__(self,
        ...
        if not threads_initialized:
            ...
            response_receiver_thread = Thread(
                target=Tello.udp_response_receiver)
    ...
    def udp_response_receiver():
        ...
        while True:
            try:
                ...
                address = address[0]
                Tello.LOGGER.debug(
                    'Data received from {} at client_socket'.format(address))
    ...
    def get_udp_video_address(self) -> str:
        ...
        address = address_schema.format(
            ip=self.VS_UDP_IP, port=self.vs_udp_port)
        return address
    ...
    def get_frame_read(self, with_queue=False, max_queue_len=32) -> 'BackgroundFrameRead':
        ...
        if self.background_frame_read is None:
            ...
            self.background_frame_read = BackgroundFrameRead(
                self, address, with_queue, max_queue_len)
...
class BackgroundFrameRead:
    ...
    def __init__(self, tello, address, with_queue=False, maxsize=32):
        ...
        try:
            ...
            self.container = av.open(self.address, timeout=(
                Tello.FRAME_GRAB_TIMEOUT, None))
